    ...
    <div className="flex min-h-screen">
      <div className="flex-1 ml-[228px] bg-[#EFF5EB] p-18">
        <div className="flex justify-between items-center p-8 border-b">
          <h2 className="text-6xl font-bold">New User</h2>
        </div>
                ...
                <div className="flex mt-2 flex-col">
                  <div>
                    <button
                      ...
                      className="text-white bg-[#6FBC44] font-bold shadow-md hover:shadow-lg hover:bg-[#5da639] py-3 px-6 rounded mr-10 disabled:opacity-50"
                    >
                      Add
                    </button>
                    <button
