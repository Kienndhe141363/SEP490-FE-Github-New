...
const DataVisualizationForm: React.FC<DataVisualizationFormProps> = () => {
    ...
    <div className="flex-1 ml-[228px] bg-[#EFF5EB] p-8 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-4">
          <div className="flex items-center gap-2">
            ...
            >
              <option value="HN24_FR_KS_04">HN24_FR_KS_04</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="bg-white p-4 rounded-lg relative">
          ...
          <p className="text-center mt-2 text-sm">Chart Title: Daily Attendance Overview</p>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg">
          ...
          <p className="text-center mt-4 text-sm ">Chart Title: Class Performance Overview</p>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg">
          ...
          <p className="text-center mt-4 text-sm ">Chart Title: Study Progress Overview</p>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg">
          ...
          <p className="text-center mt-4 text-sm ">Chart Title: Pass Rate Overview</p>
        </div>
      </div>
    </div>
  );
